...
"use strict";var e=document.querySelector(".menu"),t=document.querySelector(".menu__toggle");e.classList.remove("menu_nojs"),t.addEventListener("click",function(){e.classList.contains("menu_closed")?(e.classList.remove("menu_closed"),e.classList.add("menu_opened")):(e.classList.add("menu_closed"),e.classList.remove("menu_opened"))}),$(window).scroll(function(){100<$(document).scrollTop()?($(".fix-menu").addClass("fix-menu_fixed"),$(".chief").addClass("chief_indent"),$("#first").removeClass("active-link_home")):($(".fix-menu").removeClass("fix-menu_fixed"),$(".chief").removeClass("chief_indent"),$("#first").removeClass("active-link"),$("#first").addClass("active-link_home"))});var n=".menu";function i(){var a=$(document).scrollTop();$(n+" a").each(function(){var e=$(this).attr("href"),t=$(e);t.position().top<=a&&t.position().top+t.outerHeight()>a?($(n+" a.active-link").removeClass("active-link"),$(this).addClass("active-link")):$(this).removeClass("active-link")})}$(document).ready(function(){$("a[href^=\\#]").click(function(e){e.preventDefault(),$(document).off("scroll"),$(n+" a.active-link").removeClass("active-link"),$(this).addClass("active-link");var t=$(this).attr("href"),a=$(t);$("html, body").animate({scrollTop:a.offset().top},500,function(){console.log(window.location.hash),window.location.hash=t,console.log(window.location.hash),$(document).on("scroll",i)})})}),new Instafeed({get:"user",userId:"4783074835",clientId:"d493154c90de4ab6b0710cb5ff8d16bd",accessToken:"4783074835.d493154.5114ca90ba6a415aa6da9d44954fbc5e",resolution:"standard_resolution",template:'<a href="{{link}}" target="_blank" id="{{id}}"><img src="{{image}}" /></a>',sortBy:"most-recent",limit:9,links:!1}).run(),$(document).ready(function(){$("[data-submit]").on("click",function(e){e.preventDefault(),$(this).parent("form").submit()}),$.validator.addMethod("regex",function(e,t,a){var n=new RegExp(a);return this.optional(t)||n.test(e)},"Пожалуйста, проверьте свои данные"),$(".invite").each(function(){!function(e){e.validate({rules:{"Телефон":{required:!0,regex:"^([+]+)*[0-9 ()-]{5,20}$"},"Имя":{required:!0},"Сообщение":{required:!0}},messages:{"Телефон":{required:"Поле обязательно для заполнения",regex:"Телефон может содержать символы + - ()"},"Имя":{required:"Поле обязательно для заполнения"},"Сообщение":{required:"Поле обязательно для заполнения"}},submitHandler:function(e){var t=$(e);switch($(e).attr("id")){case"goToNewPage":$.ajax({type:"POST",url:t.attr("action"),data:t.serialize()}).always(function(e){ga("send","event","masterklass7","register"),yaCounter27714603.reachGoal("lm17lead")});break;case"popupResult":$.ajax({type:"POST",url:t.attr("action"),data:t.serialize()}).always(function(e){setTimeout(function(){$("#overlay").fadeIn(),$("#popup").fadeIn(),t.trigger("reset")},1100),$("#overlay, #close").on("click",function(e){$("#overlay").fadeOut(),$("#popup").fadeOut()})})}return!1}})}($(this))}),$("[data-scroll]").on("click",function(){$("html, body").animate({scrollTop:$($.attr(this,"data-scroll")).offset().top},2e3),event.preventDefault()})}),$(document).ready(function(){$(document).click(function(e){setTimeout(function(){$("label").fadeOut(),e.stopPropagation()},4100)})}),$(function(){$("#tel").mask("+38(099)-999-99-99")});